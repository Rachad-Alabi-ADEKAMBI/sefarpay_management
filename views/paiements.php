                    ...
                    <tbody id="payments-data">
                        ...
                        <tr data-id="2">
                            ...
                            <td>
                                <div class="tooltip">
                                    Karima Hadj
                                    <span class="tooltip-text">karima.hadj@email.com<br />+213 555 789 012</span>
                                </div>
                            </td>
                            <td>TRX987654321</td>
                            <td>2023-05-14 10:15</td>
                            <td>Achat en ligne - Vêtements</td>
                            <td>8,500.00 DZD</td>
                            <td>Wallet</td>
                            <td>
                                <span class="status status-error"><i class="fas fa-times-circle"></i> Échec</span>
                            </td>
                            <td>
                                <button class="toggle-details" data-id="2">
                                    <i class="fas fa-chevron-down"></i>
                                </button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="9" class="p-0">
                                <div id="details-2" class="transaction-details">
                                    <div class="details-grid">
                                        <div class="detail-item">
                                            <div class="detail-label">Nom du porteur</div>
                                            <div class="detail-value">Karima Hadj</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Numéro de carte</div>
                                            <div class="detail-value">XXXX XXXX XXXX 7890</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Système de paiement</div>
                                            <div class="detail-value">MasterCard</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Score de fraude</div>
                                            <div class="detail-value">0.02 (Faible)</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Adresse IP</div>
                                            <div class="detail-value">41.97.X.X</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Banque du payeur</div>
                                            <div class="detail-value">BEA</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Pays de la banque</div>
                                            <div class="detail-value">Algérie</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">ID du terminal</div>
                                            <div class="detail-value">TERM654321</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Type d'authentification</div>
                                            <div class="detail-value">3D Secure</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">Raison de l'échec</div>
                                            <div class="detail-value">Fonds insuffisants</div>
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr data-id="3">
                            ...
                            <td>
                                <div class="tooltip">
                                    Mohamed Kaci
                                    <span class="tooltip-text">mohamed.kaci@email.com<br />+213 555 456 789</span>
                                </div>
                            </td>
                            <td>TRX456789123</td>
                            <td>2023-05-13 16:45</td>
                            <td>Achat en ligne - Électroménager</td>
                            <td>45,000.00 DZD</td>
                            <td>Carte bancaire</td>
                            <td>
                            ...
                            <td>
                                <button class="toggle-details" data-id="3">
                                    <i class="fas fa-chevron-down"></i>
                                </button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="9" class="p-0">
                                <div id="details-3" class="transaction-details">
                                    <div class="details-grid">
                                        <div class="detail-item">
                                            <div class="detail-label">Nom du porteur</div>
                                            <div class="detail-value">Mohamed Kaci</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Numéro de carte</div>
                                            <div class="detail-value">XXXX XXXX XXXX 1234</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Système de paiement</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">Score de fraude</div>
                                            <div class="detail-value">0.10 (Faible)</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Adresse IP</div>
                                            <div class="detail-value">41.98.X.X</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Banque du payeur</div>
                                            <div class="detail-value">CPA</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Pays de la banque</div>
                                            <div class="detail-value">Algérie</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">Montant approuvé</div>
                                            <div class="detail-value">45,000.00 DZD</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Montant déposé</div>
                                            <div class="detail-value">En attente</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Montant remboursé</div>
                                            <div class="detail-value">0.00 DZD</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">ID du terminal</div>
                                            <div class="detail-value">TERM789123</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Type d'authentification</div>
                                            <div class="detail-value">3D Secure</div>
                        ...
                        <tr data-id="4">
                            ...
                            <td>
                                <div class="tooltip">
                                    Amina Ferhat
                                    <span class="tooltip-text">amina.ferhat@email.com<br />+213 555 234 567</span>
                                </div>
                            </td>
                            <td>TRX789123456</td>
                            <td>2023-05-12 09:20</td>
                            <td>Achat en ligne - Cosmétiques</td>
                            <td>3,200.00 DZD</td>
                            <td>Carte bancaire</td>
                            <td>
                                <span class="status status-info"><i class="fas fa-undo"></i> Remboursé</span>
                            </td>
                            <td>
                                <button class="toggle-details" data-id="4">
                                    <i class="fas fa-chevron-down"></i>
                                </button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="9" class="p-0">
                                <div id="details-4" class="transaction-details">
                                    <div class="details-grid">
                                        <div class="detail-item">
                                            <div class="detail-label">Nom du porteur</div>
                                            <div class="detail-value">Amina Ferhat</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Numéro de carte</div>
                                            <div class="detail-value">XXXX XXXX XXXX 5678</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Système de paiement</div>
                                            <div class="detail-value">Visa</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">Score de fraude</div>
                                            <div class="detail-value">0.03 (Faible)</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Adresse IP</div>
                                            <div class="detail-value">41.99.X.X</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Banque du payeur</div>
                                            <div class="detail-value">BDL</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Pays de la banque</div>
                                            <div class="detail-value">Algérie</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">Montant approuvé</div>
                                            <div class="detail-value">3,200.00 DZD</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Montant déposé</div>
                                            <div class="detail-value">3,200.00 DZD</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">ID du terminal</div>
                                            <div class="detail-value">TERM321654</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Type d'authentification</div>
                                            <div class="detail-value">3D Secure</div>
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <div class="detail-value">2023-05-13 11:45</div>
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr data-id="5">
                            ...
                            <td>
                                <div class="tooltip">
                                    Karim Boudiaf
                                    <span class="tooltip-text">karim.boudiaf@email.com<br />+213 555 890 123</span>
                                </div>
                            </td>
                            <td>TRX321654987</td>
                            <td>2023-05-11 13:50</td>
                            <td>Achat en ligne - Informatique</td>
                            <td>25,000.00 DZD</td>
                            <td>Carte bancaire</td>
                            <td>
                                <span class="status status-success"><i class="fas fa-check-circle"></i> Succès</span>
                            ...
                            <td>
                                <button class="toggle-details" data-id="5">
                                    <i class="fas fa-chevron-down"></i>
                                </button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="9" class="p-0">
                                <div id="details-5" class="transaction-details">
                                    <div class="details-grid">
                                        <div class="detail-item">
                                            <div class="detail-label">Nom du porteur</div>
                                            <div class="detail-value">Karim Boudiaf</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Numéro de carte</div>
                                            <div class="detail-value">XXXX XXXX XXXX 9012</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Système de paiement</div>
                                            <div class="detail-value">MasterCard</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">Score de fraude</div>
                                            <div class="detail-value">0.04 (Faible)</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Adresse IP</div>
                                            <div class="detail-value">41.100.X.X</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Banque du payeur</div>
                                            <div class="detail-value">BNA</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">Montant approuvé</div>
                                            <div class="detail-value">25,000.00 DZD</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Montant déposé</div>
                                            <div class="detail-value">25,000.00 DZD</div>
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">ID du terminal</div>
                                            <div class="detail-value">TERM987456</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Type d'authentification</div>
                                            <div class="detail-value">3D Secure</div>
